...
the evaluator works; they cannot pass D1-D9. D3-D8 require elapsed market sessions and
operator approvals described in `docs/DEPLOYMENT_PLAN.md`.

Gate mapping:

- D0-D2 and D9: `xenalgo.deployment`
- D3 and D4 host readiness: `xenalgo.phase32`
- D5: `xenalgo.phase33`
- D6/D7: `xenalgo.phase34` (`require_activation=False` for D6)
- D8: `xenalgo.phase35`
