...
|---|---|---|
| D0 release acceptance | Complete | PR #1 is merged. Exact merge commit `30cb28ecc664ffcc447f2dbd4780bd99221835d0` was built and promoted off-market after an isolated paper-only preflight. Its immutable image and rollback identities are recorded in private evidence; the D0 evaluator passes. |
...
- XenAlgo coverage: 90% (required minimum 90%).
...
- Research and live configuration validation: passed; live checksum
  `7957140AC8A7E9B408FE7486283F6E725D57B1FF46EA30369977C769E163D62E`.
