...
10. **[PHASE3_3_OPERATIONS.md](PHASE3_3_OPERATIONS.md)** — focused same-host production-readiness runbook.
...
13. **[DEPLOYMENT_PLAN.md](DEPLOYMENT_PLAN.md)** — permanent Oracle hosting, commissioning, rollback, and activation gates.
...
- **[DEPLOYMENT_PLAN.md](DEPLOYMENT_PLAN.md)** defines D0-D8. Local tests cannot replace host, broker, operator, or calendar-time evidence.
